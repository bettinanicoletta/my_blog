...
class BlogpostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post blogposts_url, params: { blogpost: { author: @blogpost.author, content: @blogpost.content, date: @blogpost.date, image: @blogpost.image, title: @blogpost.title } }
    end
  ...
  test "should update blogpost" do
    patch blogpost_url(@blogpost), params: { blogpost: { author: @blogpost.author, content: @blogpost.content, date: @blogpost.date, image: @blogpost.image, title: @blogpost.title } }
